...
# separate men and women into imputed datasets
...
mens_fast_lfit = loess(fastestMen ~ age_fastest_men, span=0.25)
...
qqplot(time99Norm_m, time12Norm_m, pch = 19, cex = 0.5, 
       ...
       main = "Quantile-quantile plot of male runner's performance")
abline(a =0, b = 1, col="red", lwd = 2)
