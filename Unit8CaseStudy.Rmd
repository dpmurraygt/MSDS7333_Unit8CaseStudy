...
#### Comparing Womens' Run Times for 1999 and 2012

We will also compare womens' run times between 1999 and 2012 using the same LOESS Regression technique to build a model to predict the fastest woman finisher's time for each age between 20 years old and 80 years old.
