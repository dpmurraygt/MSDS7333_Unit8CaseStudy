...
section: "MSDS 7333-403 - Quantifying the World - Case Study 3 (Unit 8)"
date: "March 6th, 2018"
output: 
  word_document:
...
```{r web_scraping, include=FALSE, echo=FALSE}
# Section 2.7 Parsing
...
``` {r export_data, include=FALSE, echo=FALSE}
# EDITS & UPDATES
...
selectCols = function(colNames, headerRow, searchLocs) 
{
  sapply(colNames, 
         function(name, headerRow, searchLocs) # for each name in col names
         {
           ...
           c(searchLocs[index] + 1, searchLocs[index + 1] - 1) # get column width
         },
...
sapply(womensFiles, length) # readLines worked

# errors out because of missing data in 2001 file
womenResMat = lapply(womensFiles, extractVariables)
