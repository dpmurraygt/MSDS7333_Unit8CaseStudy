...
# RF (non parametric) impute using random forest imputer
...
# imputed cbMen, column bind others to re-create full data set
cbMen_imp <- cbind(cbMen[, c("sex","name","home")],
                   cbMen_imp[,-4] )


# START ASSIGNMENT: NEED TO DO SAME FOR WOMEN
...
timeNorm = cbMen_imp$runTime / mens_fast_lpred[as.character(cbMen_imp$age)]
time99Norm = timeNorm[cbMen_imp$year == 1999]
time12Norm = timeNorm[cbMen_imp$year == 2012]
