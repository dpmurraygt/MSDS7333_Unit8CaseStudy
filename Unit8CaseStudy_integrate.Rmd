...
#### Note to Dennis: REMOVED imputation per professor feedback. Apparently they dont like the tie back.
#### Added in normalized analysis using LOESS. Only considered  ages 12:80 because sparsity at very 
#### young ages. Should be ready to write up. Salient points: reduced span
#### to 0.25 to catch curves better but not too close fit. Adjusted some of your code but viz works
#### there are a couple viz in EDA sections that call for an object you likely had in memory
#### but is not in .RMD. Commented up for your writing purposes.
...
# DENNIS, THIS ENTIRE BLOCK HAS CHANGED, COPY/PASTE OVER OLD LOESS_ANALYSIS_SETUP
...
hist(AllFinishers[AllFinishers$age > 80,]$age)
...
# DENNIS: CHANGE RUNMODELMEN SPAN TO 0.25 (AND CHANGE RUNMODELWOMEN BELOW)
...
``` {r women_1999v2012}
# DENNIS CHANGE RUNMODELWOMEN SPAN TO 0.25
...
plot(BestTimesW$fastest ~ BestTimesW$age, type ="l", 
     xlim = c(20, 80))
# smooth out fastest times
